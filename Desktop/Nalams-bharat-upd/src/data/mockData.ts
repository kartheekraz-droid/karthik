...
// ---------- Blog page: pending & upcoming project updates ----------
...
export const PENDING_PROJECT_UPDATES: PendingProjectUpdate[] = [
  {
    project: 'NH-48 widening',
    district: 'Pune',
    stage: 'Compensation award · 30/47 parcels acquired',
    status: 'On Track',
    progress: 64,
    note: '17 parcels remain in the objection window; hearings scheduled through next month.',
    updated: '2 days ago',
    image: 'https://picsum.photos/seed/nalams-nh48/640/420',
  },
  {
    project: 'Hyderabad Metro Phase 2',
    district: 'Hyderabad',
    stage: 'Survey & award · 95/122 parcels acquired',
    status: 'On Track',
    progress: 78,
    note: 'Corridor-B alignment finalised; remaining parcels are commercial plots under valuation review.',
    updated: '4 days ago',
    image: 'https://picsum.photos/seed/nalams-metro/640/420',
  },
  {
    project: 'Irrigation canal extension',
    district: 'Nashik',
    stage: 'Social Impact Assessment · 12/33 parcels acquired',
    status: 'Delayed',
    progress: 36,
    note: 'SIA report pending for the Sinnar stretch; district office has flagged a 3-week slip.',
    updated: '6 days ago',
    image: 'https://picsum.photos/seed/nalams-canal/640/420',
  },
  {
    project: 'Smart city ring road',
    district: 'Nagpur',
    stage: 'Forest clearance · 14/58 parcels acquired',
    status: 'Critical',
    progress: 24,
    note: '4 forest-belt parcels are blocking the remaining right-of-way pending Stage-I clearance.',
    updated: 'Today',
    image: 'https://picsum.photos/seed/nalams-ringroad/640/420',
  },
]

export interface UpcomingProjectUpdate {
  project: string
  district: string
  targetStart: string
  scope: string
...
export const UPCOMING_PROJECT_UPDATES: UpcomingProjectUpdate[] = [
  {
    project: 'Coastal highway corridor',
    district: 'Ratnagiri',
    targetStart: 'Notification expected Oct 2026',
    scope: '~210 parcels across 6 villages',
    note: 'Section 4 notification is being drafted; public consultation opens once gazetted.',
    image: 'https://picsum.photos/seed/nalams-coastal/640/420',
  },
  {
    project: 'Freight logistics park',
    district: 'Aurangabad',
    targetStart: 'Survey expected Nov 2026',
    scope: '~85 parcels, mixed agricultural & industrial',
    note: 'Preliminary land identification complete; joint measurement survey to follow.',
    image: 'https://picsum.photos/seed/nalams-freight/640/420',
  },
  {
    project: 'River-front redevelopment',
    district: 'Nagpur',
    targetStart: 'Planned for Q1 2027',
    scope: '~40 parcels, urban resettlement zone',
    note: 'R&R policy for urban resettlement is under state cabinet review before notification.',
    image: 'https://picsum.photos/seed/nalams-riverfront/640/420',
  },
]
