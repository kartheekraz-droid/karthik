    ...
    <>
      ...
      <section className="py-4">
        <div className="wrap max-w-[760px]">
          ...
          <h2>Not sure your own case adds up?</h2>
          <p>Plug in your land's numbers below and see the same calculation the government uses — no waiting on an officer to explain it.</p>
          <CompensationCalculator variant="citizen" />
        </div>
      </section>
